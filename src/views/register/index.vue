      ...
      <div id="register">
        ...
        >
          ...
          <el-form-item prop="idNo">
            <el-input v-model="ruleForm2.idNo" auto-complete="off" placeholder="请输入证件号"></el-input>
          </el-form-item>
          <el-select v-model="ruleForm2.idType" placeholder="请选择证件类型">
            <el-option
  ...
  export default {
    ...
    methods: {
      ...
      submitForm(formName) {
        ...
        https.fetchPost('/api/api/crm/userRegister',formName ).then((data) => {
